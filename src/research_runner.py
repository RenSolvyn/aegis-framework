...
def aegis_help():
    ...
    print("  │                                         │")
    print("  │  2. Brainstorm your question with the   │")
    print("  │     Brainstorm AI → get a RESEARCH PLAN │")
    print("  │                                         │")
    print("  │  3. Paste the plan into the Pipeline AI │")
    print("  │     → it writes your experiment script  │")
    print("  │                                         │")
    print("  │  4. Paste the script into Cell 2,       │")
    print("  │     run all 3 cells                     │")
    print("  │                                         │")
    print("  │  5. Copy Cell 3 results back to the     │")
    print("  │     Pipeline AI → it explains them      │")
    print("  │                                         │")
    print("  │  6. YOU decide: what does it mean?      │")
    print("  │                                         │")
...
def _print_summary(work_unit, status, elapsed_hours, budget, rigor,
    ...
    if status == "COMPLETE":
        print()
        print("  Next: run Cell 3, then copy results to your Pipeline AI.")
