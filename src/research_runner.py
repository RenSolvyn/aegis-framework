...
def aegis_help():
    ...
    print("  ├─────────────────────────────────────────┤")
    print("  │                                         │")
    print("  │  1. Tell your AI what you want to study │")
    print("  │     → it searches for prior work        │")
    print("  │     → it writes the experiment script   │")
    print("  │                                         │")
    print("  │  2. Copy the script, paste it into the  │")
    print("  │     second code box in this notebook     │")
    print("  │                                         │")
    print("  │  3. Click Runtime → Run all              │")
    print("  │                                         │")
    print("  │  4. Scroll down, copy everything between │")
    print("  │     COPY HERE and STOP COPYING markers   │")
    print("  │     and paste it back to your AI         │")
    print("  │                                         │")
    print("  │  If stuck: describe the problem to your  │")
    print("  │  AI. It will help you fix it.            │")
    print("  └─────────────────────────────────────────┘")
    print()
...
def _print_summary(work_unit, status, elapsed_hours, budget, rigor,
    ...
    if status == "COMPLETE":
        print()
        print("  Next: scroll down to see your results. Copy everything")
        print("  between the COPY/STOP markers and paste to your AI.")
