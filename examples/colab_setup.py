...
def setup():
    ...
    notebook = {
        ...
        "cells": [
            ...
            {"cell_type": "code", "metadata": {}, "source": [
                "# CELL 2: PASTE YOUR EXPERIMENT SCRIPT BELOW\\n",
                "# Select all in this cell (Ctrl+A), then paste your script (Ctrl+V)\\n",
                "# The script from your AI replaces everything in this cell\\n",
            ], "outputs": [], "execution_count": None},
            {"cell_type": "code", "metadata": {}, "source": [
