...
**Phase 1: Think** — describe your curiosity, the AI searches for
prior work, then sharpens it into a testable question with a plan
...
2. The AI searches for prior work, then explores the idea with
   you — challenges assumptions, narrows the question, checks if
   it's already been answered. When the question is sharp enough,
   it produces a **RESEARCH PLAN** and the experiment script
   together.
...
**Keeps you honest.** Before you start, the AI searches for prior
work — if someone already answered your question, you'll know
before wasting time. Your predictions are locked before the
...
- **Question killing** — the AI searches for prior work and
  challenges bad questions before you waste time (already
  answered? unfalsifiable? too broad?)
